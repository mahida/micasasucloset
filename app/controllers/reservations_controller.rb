class ReservationsController < ApplicationController
	...
	def create
		...
		if @reservation
			...
			values = {
				business: 'courtney.mahida-facilitator@gmail.com',
				cmd: '_xclick',
				upload: 1,
				...
				quantity: '1',
				return: 'http://localhost:3000/your_storage'
			}
	...
	protect_from_forgery except: [:your_storage]
	def your_storage
		@storage = current_user.reservations.where("status = ?", true) 
	end
